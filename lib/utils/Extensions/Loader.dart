...
class LoaderState extends State<Loader> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: 60,
      width: 60,
      decoration: widget.decoration ?? BoxDecoration(color: Colors.black, shape: BoxShape.circle, boxShadow: defaultBoxShadow()),
      child: CircularProgressIndicator().withHeight(25).withWidth(25).paddingAll(2),
    ).center();
  }
}
