...
class _TouchDetectorState extends State<TouchDetector> {
  ...
  @override
  Widget build(BuildContext context) => GestureDetector(onTapUp: widget.onTapUp, onPanStart: onPanStart, onPanUpdate: onPanUpdate, onPanEnd: onPanEnd, child: widget.child);
  ...
  void onPanUpdate(DragUpdateDetails details) {
    ...
    if (offsetDifferenceX.abs() > _thresholdGlobalPositionDistance) {
      _initialOffset = _finalOffset;
      widget.onTouch(details.delta.dx < 0 ? TouchAction.left : TouchAction.right);
    }
  }
